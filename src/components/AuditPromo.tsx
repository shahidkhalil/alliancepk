        ...
        >
          <div className="flex-1 text-center lg:text-left">
            ...
            <h2 className="text-2xl lg:text-3xl font-extrabold text-white tracking-tight mb-3">
              See What Your Clinic Could Automate<br className="hidden lg:block" />
              <span className="text-[#9FD3E8]"> in 30 Seconds.</span>
            </h2>
            <p className="text-white/60 text-sm max-w-xl mb-6">
              Our AI audits your clinic&apos;s site with real data — speed, SEO, booking experience, and the competitors outranking you — then shows which gaps automation closes. Free, no signup.
            </p>
