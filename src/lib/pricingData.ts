  ...
  },
{
    ...
    tagline: "Paid search plus content creatives, posts, and short-form video — so Google campaigns launch with assets ready to convert.",
    packages: [
      {
        name: "Basic",
        price: "$500",
        period: "/ month + ad spend",
        description: "Managed Google Search campaigns with starter ad creatives and light content posting for practices ready to generate patient leads.",
        features: [
          ...
          "Static display / responsive ad creatives",
          "4 organic feed posts / month (captions included)",
        ...
        popular: false,
        addOns: ["Display/retargeting campaign +$149/mo", "Extra Reels / Shorts pack (4) +$349/mo"],
      },
      {
        name: "Standard",
        price: "$900",
        period: "/ month + ad spend",
        savings: "Ads + creatives + posts in one plan",
        description: "Multi-campaign Google Ads with A/B testing, plus ongoing creatives, feed posts, and short-form video for Search, Display, and retargeting.",
        features: [
          ...
          "8 organic feed posts / month",
          "2 Reels / YouTube Shorts / month",
          "Display + remarketing creative set",
          "Monthly content calendar (you approve)",
        ...
        cta: "Launch Campaigns",
        popular: true,
        addOns: ["YouTube ads campaign +$299/mo", "Extra 4 Reels / Shorts +$349/mo"],
      },
      {
        name: "Premium",
        price: "$1,400",
        period: "/ month + ad spend",
        description: "Full-funnel Google Ads — Search, Display, YouTube, Performance Max — with a managed content engine for posts, creatives, and short-form video.",
        features: [
          "Unlimited campaigns",
          ...
          "16 organic feed posts / month",
          "6 Reels / YouTube Shorts / month",
          "Full ad creative pack (static + video cuts)",
          "Full content calendar + asset library",
          "Custom landing pages per campaign",
          "Call tracking with call recording",
          "CRM integration for offline conversion import",
          "Competitive intelligence reporting",
          "Weekly dashboard + dedicated ads + creative specialist",
          "Weekly check-in call",
        ],
        cta: "Book a Strategy Call",
        popular: false,
        addOns: ["Meta Ads bundle at $1,499/mo (save $500)", "On-site shoot day +$799"],
      },
    ],
    comparison: [
      ...
      { feature: "Organic feed posts", basic: "4 / mo", standard: "8 / mo", premium: "16 / mo" },
      { feature: "Reels / Shorts", basic: "Add-on", standard: "2 / mo", premium: "6 / mo" },
      { feature: "Ad creatives", basic: "Static + copy", standard: "Display + remarketing set", premium: "Full static + video pack" },
      { feature: "Content calendar", basic: "Light", standard: "Monthly + approval", premium: "Fully managed" },
    ...
    faqs: [
      ...
      { q: "Are posts, creatives, and Reels included?", a: "Yes — they're built into Google Ads plans, not a separate product. Basic includes starter posts and static creatives; Standard adds Reels/Shorts and a remarketing creative set; Premium is a full managed content + ads engine." },
    ...
    timeline: "Campaigns live within 3–5 business days; first content calendar in the same window",
    technologies: ["Google Ads", "Google Analytics 4", "Google Tag Manager", "YouTube", "CallRail", "CapCut / Premiere", "Canva / Figma", "HubSpot", "Looker Studio"],
  ...
  },
{
    ...
    category: "Digital Marketing",
    tagline: "Facebook & Instagram ads plus content posting, creatives, and Reels — so paid campaigns and your organic feed work as one system.",
    packages: [
      {
        name: "Basic",
        price: "$500",
        period: "/ month + ad spend",
        description: "Foundational Meta advertising with starter creatives and light organic posting for practices ready to show up on Facebook and Instagram.",
        features: [
        ...
        cta: "Launch Campaigns",
        popular: false,
        addOns: ["Extra Reels pack (4) +$349/mo", "Retargeting setup +$149/mo"],
      },
      {
        name: "Standard",
        price: "$1,000",
        period: "/ month + ad spend",
        savings: "Ads + posts + Reels in one plan",
        description: "Full-funnel Meta campaigns with lookalikes, A/B testing, and ongoing creatives — including feed posts, Stories, and Reels.",
        features: [
          ...
          "8 organic feed posts / month",
          "2 Reels / short-form videos / month",
        ...
        cta: "Launch Campaigns",
        popular: true,
        addOns: ["Extra 4 Reels +$349/mo", "On-site shoot day +$799"],
      },
      {
        name: "Premium",
        price: "$1,500",
        period: "/ month + ad spend",
        description: "Full-funnel Meta ads plus a managed content engine — high-volume posts, Reels, and ad-ready creatives with daily optimization.",
        features: [
          "Unlimited ad sets",
          "Unlimited ad spend management",
          ...
          "16 organic feed posts / month",
          "6 Reels / short-form videos / month",
          "16 Story frames / month",
          "Ad-ready creative pack (static + video cuts)",
          "Full content calendar + publishing management",
          "Advanced Pixel events + server-side tracking",
          "CRM integration for offline conversions",
          "Daily optimization + weekly dashboard",
          "Dedicated Meta ads + creative specialist",
          "Weekly check-in",
        ],
        cta: "Book a Strategy Call",
        popular: false,
        addOns: ["Google Ads bundle at $1,499/mo (save $500)", "UGC creator coordination +$499/mo"],
      },
    ],
    comparison: [
      ...
      { feature: "Organic feed posts", basic: "4 / mo", standard: "8 / mo", premium: "16 / mo" },
      { feature: "Reels / short video", basic: "Add-on", standard: "2 / mo", premium: "6 / mo" },
      { feature: "Stories", basic: false, standard: "8 frames", premium: "16 frames" },
      { feature: "Content calendar", basic: "Light", standard: "Monthly + approval", premium: "Fully managed" },
      ...
      { feature: "Ad-ready creative pack", basic: "Static only", standard: "Select cuts", premium: "Full pack" },
    ...
    faqs: [
      ...
      { q: "Are posts and Reels included, or is that separate?", a: "They're included in Meta Ads plans — not a separate product. Basic covers starter feed posts; Standard adds Reels and Stories; Premium is a full managed content + ads engine." },
      ...
      { q: "Do you create the ad creative?", a: "Yes — every plan includes creatives. Basic covers static ads plus light organic posts. Standard and Premium add Reels, Stories, and stronger creative testing so paid and organic stay consistent." },
    ...
    timeline: "Campaigns live within 3–5 business days; first content calendar in the same window",
    technologies: ["Meta Ads Manager", "Meta Pixel", "Meta Conversions API", "Meta Business Suite", "CapCut / Premiere", "Canva / Figma", "HubSpot", "Looker Studio"],
    support: "Account manager + creative consultation included on Standard and Premium",
...
const ACTIVE_IDS = [
  ...
  "meta-ads",               // ads + content / creatives / reels
] as const;
