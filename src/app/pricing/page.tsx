...
function WhySection() {
  const points = [
    { title: "No Hidden Fees", desc: "Every line item is on this page. The number you see is the number on your invoice — no surprise setup or platform charges." },
    { title: "You Own Everything", desc: "Code, assets, ad accounts, and patient data are 100% yours at delivery. Walk away whenever you like and it all stays with you." },
    { title: "US Healthcare Focused", desc: "Built for US clinics only — HIPAA-ready infrastructure, US-market pricing, and copywriting that sounds like your front desk." },
    { title: "Guaranteed Results", desc: "Most services carry a performance or satisfaction guarantee. If we miss the KPIs we agreed on, you don't pay for the month." },
  ];
  return (
    <section className="border-t border-gray-100 py-14 bg-[#F8FAFC]">
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 text-sm mt-3">Four promises we put in writing before you spend a dollar.</p>
        </div>
        <FeatureCardGrid
